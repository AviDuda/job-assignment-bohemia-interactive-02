...
interface SvgSortIconProps {
    activeDirection?: SortDirection;
}
export default function SvgSortIcon({ activeDirection }: SvgSortIconProps) {
    return (
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_407_475)">
                <path
                    ...
                    className={
                        !activeDirection || activeDirection === SortDirection.Ascending ? "fill-black" : "fill-gray-400"
                    }
                />
                <path
